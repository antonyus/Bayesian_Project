...
post_summary_select <- post_summary_select %>%
...
vaccination_coverage_by_year <- cbind(years, round(coverage_percent,3))
...
## Answer
Posterior estimate of the vaccination coverage per birth year were given in table 5.
